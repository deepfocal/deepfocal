"""
Django settings for deepfocal_backend project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'deepfocal_dev', # The name for our new database
        'USER': 'postgres', # The default postgres user
        'PASSWORD': 'YOUR_POSTGRES_PASSWORD_HERE', # The password you set during installation
        'HOST': 'localhost', # Connect to the database on your own computer
